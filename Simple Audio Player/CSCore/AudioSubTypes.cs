...
// ReSharper disable InconsistentNaming
		...
		/// </summary>
		public static readonly Guid WAVE_FORMAT_MPEG_HEAAC = new Guid((int)AudioEncoding.WAVE_FORMAT_MPEG_HEAAC, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71);
		/// <summary>
		...
		///     WMASPDIF
		/// </summary>
		public static readonly Guid WAVE_FORMAT_WMASPDIF = new Guid((int)AudioEncoding.WAVE_FORMAT_WMASPDIF, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71);
		/// <summary>
		///     Windows Media Audio lossless
		/// </summary>
		public static readonly Guid WAVE_FORMAT_WMAUDIO_LOSSLESS = new Guid((int)AudioEncoding.WAVE_FORMAT_WMAUDIO_LOSSLESS, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71);
		/// <summary>
		///     Windows Media Audio 2
		/// </summary>
		public static readonly Guid WAVE_FORMAT_WMAUDIO2 = new Guid((int)AudioEncoding.WAVE_FORMAT_WMAUDIO2, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71);
		/// <summary>
		///     Windows Media Audio 3
		/// </summary>
		public static readonly Guid WAVE_FORMAT_WMAUDIO3 = new Guid((int)AudioEncoding.WAVE_FORMAT_WMAUDIO3, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71);
