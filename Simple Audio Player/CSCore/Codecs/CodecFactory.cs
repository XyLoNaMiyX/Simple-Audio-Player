...
// ReSharper disable once InconsistentNaming
        static readonly CodecFactory _instance = new CodecFactory();

        readonly Dictionary<object, CodecFactoryEntry> _codecs;
        ...
        IWaveSource OpenWebStream(string url)
        {
            try
            {
                return Default(url);
...
#pragma warning restore 618
        ...
        IWaveSource Default(string url)
        {
