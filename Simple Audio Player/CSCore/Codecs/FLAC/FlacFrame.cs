...
namespace CSCore.Codecs.FLAC
{
    public sealed class FlacFrame
    {
        ...
        FlacFrame(Stream stream)
            : this(stream, null)
        {
        }

        FlacFrame(Stream stream, FlacMetadataStreamInfo streamInfo)
        {
        ...
        void Decode(Stream stream, FlacMetadataStreamInfo streamInfo)
        {
        ...
        unsafe void SamplesToBytes(List<FlacSubFrameData> data)
        {
        ...
        unsafe List<FlacSubFrameData> AllocOuputMemory()
        {
