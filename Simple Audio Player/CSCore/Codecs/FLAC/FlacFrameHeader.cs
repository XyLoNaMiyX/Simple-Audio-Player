...
namespace CSCore.Codecs.FLAC
{
    ...
    {
        int _blocksizeHint = 0; //if bsindex == 6 || 7
        int _sampleRateHint = 0; //if sampleRateIndex == 12 || 13 || 14
        ...
        unsafe bool ParseHeader(Stream stream, FlacMetadataStreamInfo streamInfo)
        {
        ...
        unsafe bool ParseHeader(ref byte* headerBuffer, FlacMetadataStreamInfo streamInfo)
        {
