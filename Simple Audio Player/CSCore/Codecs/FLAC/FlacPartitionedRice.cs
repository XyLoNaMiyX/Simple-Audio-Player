...
namespace CSCore.Codecs.FLAC
{
    public class FlacPartitionedRice
    {
        ...
        public FlacPartitionedRiceContent Content { get; set; }

        public FlacEntropyCoding CodingMethod { get; set; }
        ...
        unsafe void ReadFlacRiceBlock(FlacBitReader reader, int nvals, int riceParameter, int* ptrDest)
        {
