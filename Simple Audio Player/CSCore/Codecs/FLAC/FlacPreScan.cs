...
namespace CSCore.Codecs.FLAC
{
    internal sealed class FlacPreScan
    {
        ...
        public List<FlacFrameInformation> Frames { get; set; }
        ...
        void StartScan(FlacMetadataStreamInfo streamInfo, FlacPreScanMethodMode method)
        {
            if (_isRunning)
        ...
        List<FlacFrameInformation> RunScan(FlacMetadataStreamInfo streamInfo)
        {
#if DEBUG
        ...
        void RaiseScanFinished(List<FlacFrameInformation> frames)
        {
            if (ScanFinished != null)
                ScanFinished(this, new FlacPreScanFinishedEventArgs(frames));
        }

        unsafe List<FlacFrameInformation> ScanThisShit(FlacMetadataStreamInfo streamInfo)
        {
        ...
        unsafe bool IsFrame(ref byte* buffer, FlacMetadataStreamInfo streamInfo, FlacFrameHeader baseHeader, out FlacFrameHeader header)
        {
