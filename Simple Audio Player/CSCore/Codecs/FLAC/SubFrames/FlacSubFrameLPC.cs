...
namespace CSCore.Codecs.FLAC
{
    public sealed class FlacSubFrameLPC : FlacSubFrameBase
    {
        ...
        readonly int[] _qlpCoeffs;
        readonly int _lpcShiftNeeded;
        readonly int _qlpCoeffPrecision;
        ...
        public FlacResidual Residual { get; set; }
        ...
        unsafe void Restore(int* residual, int* dest, int length, int predictorOrder, int destOffset)
        {
        ...
        unsafe void RestoreLPCSignal(int* residual, int* destination, int length, int order)
        {
            int sum = 0;
        ...
        unsafe void RestoreLPCSignalWide(int* residual, int* destination, int length, int order)
        {
            long sum = 0;
