...
namespace CSCore.Codecs.MP3
{
    ...
    public class DmoMp3Decoder : DmoStream
    {
        ...
        DmoMP3DecoderObject _comObj;
        FrameInfoCollection _frameInfoCollection;
        Mp3Format _inputFormat;
        ...
        void ParseForMp3Frames(Stream stream, bool enableSeeking)
        {
            Mp3Frame frame = null;
...
// ReSharper disable once InconsistentNaming
        Mp3Frame ReadNextMP3Frame(ref byte[] frameBuffer)
        {
        ...
        sealed class DmoMP3DecoderObject
        {
        }
    }
}