...
namespace CSCore.Codecs.MP3
{
    ...
    public class Mp3Frame
    {
        ...
        long _streamPosition, _dataPosition;
        byte[] _headerBuffer;
        ...
        Mp3Frame(Stream stream)
        {
            _stream = stream;
        }

        bool FindFrame(Stream stream, bool seek)
        {
            if (stream == null) 
        ...
        /// Gets the Mpeg Layer.
        /// </summary>
        public MpegLayer MPEGLayer { get; set; }
        ...
        /// </summary>
        public Mp3ChannelMode ChannelMode { get; set; }
        ...
        /// </summary>
        public int ChannelExtension { get; set; }
        ...
        short GetChannelCount(Mp3ChannelMode channelsMode)
        {
