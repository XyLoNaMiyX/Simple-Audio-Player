...
namespace CSCore.Codecs.MP3
{
    ...
    public class Mp3WebStream : IWaveSource
    {
        ...
        Stream _bufferingStream;
        DmoMp3Decoder _decoder;
...
// ReSharper disable once PossibleNullReferenceException
        ...
        int ReadRawDataFromFrame(ref byte[] buffer, out Mp3Frame frame)
        {
            bool success = false;
            frame = null;
            do
        ...
        Mp3Frame GetNextFrame(Stream stream, ref byte[] frameBuffer)
        {
            Mp3Frame frame;
            do
            {
        ...
        static bool SetAllowUnsafeHeaderParsing20()
        {
            ...
            if (aNetAssembly != null)
            {
                ...
                if (aSettingsType != null)
                {
                    ...
                    if (anInstance != null)
                    {
                        //Locate the bool field that tells the framework is unsafe header parsing should be allowed or not
