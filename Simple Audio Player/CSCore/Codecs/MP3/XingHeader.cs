...
namespace CSCore.Codecs.MP3
{
    ...
    public class XingHeader
    {
        ...
        static int CalcOffset(Mp3Frame frame)
        {
            int offset = 0;
        ...
        static bool CheckForValidXingHeader(Mp3Frame frame, int offset)
        {
            byte[] data = null;
        ...
        static int ReadHeaderFlags(Mp3Frame frame, int offset)
        {
            byte[] data = null;
            if (frame.ReadData(ref data, 0) < 4)
