...
namespace CSCore.DSP
{
    ...
    public class ChannelMatrix
    {
        ...
        readonly ChannelMask _inputMask;
        readonly ChannelMatrixElement[,] _matrix;
        readonly ChannelMask _outputMask;
        ...
        static ChannelMask[] GetValuesOfChannelMask(ChannelMask channelMask)
        {
