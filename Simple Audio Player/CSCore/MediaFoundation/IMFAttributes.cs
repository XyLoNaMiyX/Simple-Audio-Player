...
namespace CSCore.MediaFoundation
{
    ...
    public interface IMFAttributes
    {
        ...
        /// </summary>
        void GetItem([In, MarshalAs(UnmanagedType.LPStruct)] Guid guidKey, [In, Out] ref PropertyVariant pValue);
        ...
        /// </summary>
        void GetItemByIndex(int unIndex, out Guid pGuidKey, [In, Out] ref PropertyVariant pValue);
