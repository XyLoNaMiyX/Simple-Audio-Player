...
namespace CSCore.MediaFoundation
{
    ...
    public class MediaFoundationDecoder : IWaveSource
    {
        ...
        long _length;
        long _position; //could not find a possibility to find out the position -> we have to track the position ourselves.
        readonly bool _hasFixedLength;
        ...
        long GetLength(MFSourceReader reader)
        {
            lock (_lockObj)
            {
                try
        ...
        int CopyDecoderBuffer(byte[] destBuffer, int offset, int count)
        {
