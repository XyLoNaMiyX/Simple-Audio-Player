...
namespace CSCore.MediaFoundation
{
    ...
    {
        ComStream _targetBaseStream;
        bool _disposed;
        long _position;
        MFSinkWriter _sinkWriter;
        int _sourceBytesPerSecond;
        int _streamIndex;
        MFMediaType _targetMediaType;
        IMFByteStream _targetStream;
            ...
            Guid containerType)
        {
            ...
            try
            {
                ...
                _targetStream.GetCapabilities(ref flags);
        ...
        long WriteBlock(byte[] buffer, int offset, int count, int streamIndex, long positionInTicks,
        ...
        static long BytesToNanoSeconds(int byteLength, int bytesPerSecond)
        {
