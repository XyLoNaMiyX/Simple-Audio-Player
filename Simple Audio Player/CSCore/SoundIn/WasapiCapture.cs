...
namespace CSCore.SoundIn
{
    ...
    public class WasapiCapture : ISoundRecorder
    {
        ...
        readonly ThreadPriority _captureThreadPriority;
        readonly SynchronizationContext _synchronizationContext;
        volatile RecordingState _recordingState;
        ...
        void ReadData(byte[] buffer, AudioCaptureClient captureClient, uint frameSize)
        {
        ...
        void RaiseDataAvilable(byte[] buffer, int offset, int count)
        {
            if (count <= 0)
                return;
        ...
        bool CheckForSupportedFormat(AudioClient audioClient, IEnumerable<WaveFormatExtensible> waveFormats, out WaveFormat foundMatch)
        {
            foundMatch = null;
