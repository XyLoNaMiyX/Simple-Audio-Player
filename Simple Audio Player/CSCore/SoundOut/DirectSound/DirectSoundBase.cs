...
namespace CSCore.SoundOut.DirectSound
{
    ...
    public unsafe class DirectSoundBase : ComObject
    {
        ...
        {
            IntPtr resultPtr;
            var result = InteropCalls.CalliMethodPtr(UnsafeBasePtr, bufferOriginal.BasePtr.ToPointer(), &resultPtr, ((void**)(*(void**)UnsafeBasePtr))[5]);
        ...
        {
            return InteropCalls.CalliMethodPtr(UnsafeBasePtr, speakerConfig, ((void**)(*(void**)UnsafeBasePtr))[9]);
        }

        public DSResult Initialize(Guid device)
        {
            return InteropCalls.CalliMethodPtr(UnsafeBasePtr, &device, ((void**)(*(void**)UnsafeBasePtr))[10]);
        }
    }
}