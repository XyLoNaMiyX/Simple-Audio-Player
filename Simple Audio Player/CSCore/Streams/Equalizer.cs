...
namespace CSCore.Streams
{
    ...
    {
        readonly EqualizerFilterCollection _equalizerFilters = new EqualizerFilterCollection();
        ...
        class EqualizerFilterCollection : IList<EqualizerFilter>
        {
            readonly List<EqualizerFilter> _list = new List<EqualizerFilter>();
