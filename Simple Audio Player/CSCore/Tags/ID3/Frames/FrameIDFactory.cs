...
namespace CSCore.Tags.ID3.Frames
{
    public static class FrameIDFactory
    {
        ...
        static Dictionary<string, string> CreateVersion3To2Map()
        {
            Dictionary<string, string> map = new Dictionary<string, string>();
            map.Add("AENC", "CRA");
            map.Add("APIC", "PIC");
