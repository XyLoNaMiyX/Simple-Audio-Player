...
namespace CSCore.Tags.ID3
{
    ...
    public class ID3v2 : IEnumerable<Frame>
    {
        ...
        static ID3v2 FromStream(Stream stream, bool readData)
        {
            ID3v2 id3v2 = new ID3v2(stream);
        ...
        bool ReadData(Stream stream, bool readData)
        {
