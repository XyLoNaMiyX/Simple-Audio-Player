...
namespace CSCore.XAudio2
{
    ...
    public class StreamingSourceVoiceListener : IDisposable
    {
        ...
        static volatile StreamingSourceVoiceListener _default;
// ReSharper disable once InconsistentNaming
        static readonly object _singleTonSync = new object();

        readonly List<StreamingSourceVoice> _items = new List<StreamingSourceVoice>();
        readonly object _lockObject = new object();
        bool _disposed;
        bool _isRunning;
        volatile bool _itemsChanged;
