...
// ReSharper disable once InconsistentNaming
        X3DAudioCalculateDelegate _calculateDelegate;
        IntPtr _hModule;
        X3DAudioHandle _handle;

        X3DAudioInitializeDelegate _initializeDelegate;
        ...
        void X3DAudioCalculate(IntPtr instance, IntPtr listener, IntPtr emitter, CalculateFlags flags,
            IntPtr dspSettingsPtr)
        {
            _calculateDelegate(instance, listener, emitter, (int) flags, dspSettingsPtr);
        }

        unsafe void X3DAudioInitialize(ChannelMask speakerChannelMask, float speedOfSound,
        ...
        TDelegate GetUnmanagedProc<TDelegate>(IntPtr hModule, string procName)
        ...
        delegate void X3DAudioCalculateDelegate(IntPtr arg0, IntPtr arg1, IntPtr arg2, int arg3, IntPtr arg4);

        [SuppressUnmanagedCodeSecurity]
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        //msdn tells me that this should be __stdcall. But according to the header files __cdecl is used instead of __stdcall.
        delegate void X3DAudioInitializeDelegate(int arg0, float arg1, IntPtr arg2);
